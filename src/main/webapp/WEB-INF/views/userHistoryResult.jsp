                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-hover" id="table">
                                    ...
                                    <c:forEach var="x" items="${list}"> 
                                     	<tr class="info">
	                                    	...
	                                    	<td id="transactionType"> <B> ${x.transactionType }</B> </td>
	                                    	<td id="transactionAmount"> <B>CNY ${x.transactionAmount } </B></td>
                                    	</tr>
                                    </c:forEach>
                                ...
                                <%
                                	...
                                	if(session.getAttribute("pages")==null){
                                		...
                                		pages= Integer.parseInt((String)session.getAttribute("pages"));	
                                	}
                                ...
                                %>
                                 <li><a href="userHistoryC?currentPage=<%= prePage%>">&laquo;</a></li>
                                <%
                                	
                                	for(int i=1;i<pages+1;i++){%>
                                		
                                	
                                	<li ><a  href="userHistoryC?currentPage=<%=i %>"><%=i %></a>
                                
                                <% }%>
                                <li onclick='add(this)'><a href="userHistoryC?currentPage=<%=nextPage %>">&raquo;</a></li>
                                </ul>
                                ...
                                <form role="form" method="post" action="userHistory">
	                                  ...
	                                  <button type="button" class="btn btn-info" onclick="back()">Return</button>
