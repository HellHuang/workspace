                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-lg-10">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="userHistoryC">
                                 ...
                                 <br>
                                   ...
                                   <br>
										      ...
										      <div class="form-group"><span><B>Start Date </B></span>
										        <div class='input-group date' id='datetimepicker6'>
														<input required="required" type='text' class="form-control" name="startDate"/>
										    ...
										    <div class='input-group date' id='datetimepicker7'>
										     <input required="required" type='text' class="form-control" style="block:none" name="endDate"/>
										      <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>  </span>
