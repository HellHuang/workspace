...
<div class="banner">
							...
							<div class="panel panel-info">
								...
								<div class="panel-body">
									<div class="form-group">
										<label>Card Number:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
									...
									<div class="form-group">
										...
										&nbsp&nbsp CNY ${RMBbalance}</label>
										<input type="hidden" value=${RMBbalance} name="balance" id="balance">
									</div>
									<div class="form-group">
										<label>Exchange Currency:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
										&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ${currencyType}</label>
										<input type="hidden" value=${currencyType} name="currencyType" id="currencyType">
									</div>
									<div class="form-group">
										<label>Exchange Amount:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
										&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ${amount}</label>
										<input type="hidden" value=${amount} name="amount" id="amount">
									</div>
									<div class="form-group">
										<label>Exchange Offer Rate:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
										&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ${rate}</label>
										<input type="hidden" value=${rate} name="rate" id="rate">
									</div>
									<div class="form-group">
										<label>Required RMB amount:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
										&nbsp&nbsp&nbsp CNY ${requiredMoney}</label>
										<input type="hidden" value=${requiredMoney} name="requiredMoney" id="requiredMoney">
									</div>
									<div class="form-group">
 ...
 <script>
 	function check(){
 		...
 		var requiredMoney=document.getElementById("requiredMoney");
 		var amount=document.getElementById("amount");
 		var cardpin=document.getElementById("cardpin");
 		$.ajax({
 			url:"<%=request.getContextPath()%>/userCurrencyBuy",
 			type:"POST",
 			dataType:"text",
 			data:{
 				'cardNumber':cardNumber.value,
 				'currencyType':currencyType.value,
 				'requiredMoney':requiredMoney.value,
 				'amount':amount.value,
 			...
 			success:function(data){
				...
				if(data=="isFronze"){
				...
				else if(data=="noBlance"){
					bootbox.alert("<br><B>Balance of this card is not enough",function (){
						window.history.back()});
					return false;
				}
					...
					bootbox.alert("<br><B>Exchange to foreign currency is successful",function (){
						window.location.href="userForeignExchange";});
					return false;
				}
				else if(data=="failed"){
