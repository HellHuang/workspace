                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                         ...
                         <div class="panel-heading" style="background-color:#7BCEC4;">
                          <label>Time deposit enquiry</label>
                        </div>
                         	 <div class="panel-body">
                         	 	 <form role="form" >
                         	 	 	<div class="form-group">
                                            <label class="col-md-6 col-lg-6">Deposit card number:</label>
                                            <label class="col-md-6 col-lg-6">${x.cardNumberFrom }</label>    	
                                    </div>
                                    <div class="form-group">
                                            <label class="col-md-6 col-lg-6">Deposit number:</label>
                                            <label class="col-md-6 col-lg-6">${x.depositNumber }</label>    	
                                    </div>
                                     <div class="form-group">
                                            <label class="col-md-6 col-lg-6">Deposit term: </label>
                                            <label class="col-md-6 col-lg-6">${x.term } Year</label>
                                     </div>
                                     <div class="form-group">
                                            <label class="col-md-6 col-lg-6">Deposit amount:</label>
                                            <label class="col-md-6 col-lg-6">CNY ${x.amount }</label>
                                     ...
                                     <div class="form-group">
                                            ...
                                            <label class="col-md-6 col-lg-6">${x.interestRate }%</label>
                        ...
                        <div class="col-md-12">                            		
                            ...
                            <div class="col-md-4">
                            	<button class="btn btn-info" type="button" onclick="tiao()">Back</button>
                            </div>    
                            <div class="col-md-4"></div>                       		
                        </div>	
                        <!-- /. ROW  -->
...
<!--footer end here-->
 ...
 <script>
 	function tiao(){
 		window.location.href="userEnquiry";
 	}
 </script>
</body>
</html>