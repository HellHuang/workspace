					...
					<div class="header-right">
						<div class="head-top">
							...
							<div class="top-nav-right" style="margin-left: 10px">
								...
								<a href="dataSelect">
									<h1 class="glyphicon glyphicon glyphicon-star"
										style="font-size: 1.5em; color: red"></h1>
								</a>
							</div>
							<div class="ph-numb">
                    ...
                    <li>
                     ...
                     <li>
						...
						<nav class="navbar  sidebar navbar-fixed-top" role="navigation">
							<div class="nav-side-menu navbar-default navbar-side"
								role="navigation">
						...
						<div class="row">
							...
							<div class="row" style="margin-top:20px">
								...
								<div class="col-md-8">
									...
									<div class="">
										<form id="form" method="POST" action="data">
											<div class="form-group">
												<label>Please choose your card account number</label>
												<c:forEach var="x" items="${cardList}">
													<div class="radio">
														<label> <input type="radio" name="cardNumber"
															id="cardNumber" value=${x }> ${x }
														</label>
											...
											<button type="submit" class="btn btn-info" value="1"
												onclick="submitFun(this.value)">Enquiry</button>
