                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="panel-heading" style="background-color:#7BCEC4">
                          Time-Deposit Enquiry
                        </div>
                        <div class="panel-body">
                            <form  method="post" action="userTermEnquiry" >
                                        <div class="form-group">
                                            <label>Please choose your card account number</label>
                                             <c:forEach var="x" items="${cardList}"> 
                                              <div class="radio">
                                            	<label>
                                            	<input type="radio" name="cardNumber" id="cardNumber" value=${x } > ${x }
                                            	</label>
                                            
                                            </div>
                                             </c:forEach>
                                        </div>
	                                  <button type="submit" class="btn btn-info">Time-Deposit Enquiry </button>
